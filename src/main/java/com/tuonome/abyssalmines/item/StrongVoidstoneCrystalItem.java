// src/main/java/com/tuonome/abyssalmines/item/StrongVoidstoneCrystalItem.java
...
public class StrongVoidstoneCrystalItem extends Item {
    private static final String LIGHT_POS_KEY = "abyssal_mines.strong_voidstone_crystal_light_pos";
    private static final int LIGHT_LEVEL = 12;

    public StrongVoidstoneCrystalItem(Properties properties) {
        super(properties);
    }
